...
public class DefaultSocketClientTest {
    private static Logger logger         = LoggerFactory.getLogger(DefaultSocketClientTest.class);
    ...
    public static void main(String[] args) {
        String preLen = String.format("%08d", new Object[] { Integer.valueOf(8) });
        System.out.println(preLen);
        int len = Integer.parseInt(new String("00000008"));
