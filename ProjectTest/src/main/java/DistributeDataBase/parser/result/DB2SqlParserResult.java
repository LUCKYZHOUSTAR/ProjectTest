...
public class DB2SqlParserResult extends DefaultSqlParserResult
{
  ...
  {
    ZdalDB2SchemaStatVisitor oracleVisitor = (ZdalDB2SchemaStatVisitor)this.visitor;
  ...
  {
    ZdalDB2SchemaStatVisitor db2SchemaVisitor = (ZdalDB2SchemaStatVisitor)this.visitor;
    Set rowNums = db2SchemaVisitor.getRownums();
    if ((rowNums == null) || (rowNums.isEmpty())) {
      return -1;
    }
    for (BindVarCondition rowNum : rowNums) {
